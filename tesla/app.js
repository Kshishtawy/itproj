...
gsap.to(".scrollDown", {y: 1, repeat: -1, ease: "elastic", duration: 2, yoyo: true});
...
gsap.from(".s2Stag", {scrollTrigger: { trigger: ".s2Stag", start: "top 60%"}, stagger: 0.4, y: 100, opacity: 0, duration: 1});

gsap.from(".s3Shade", {scrollTrigger: { trigger: ".s3Shade", start: "top 40%"}, stagger: 0.4, x: -100, opacity: 0, duration: 0.2});

gsap.from(".leftimg", {scrollTrigger: { trigger: ".leftimg", start: "top center"}, x: -100 , opacity: 0, duration: 2, ease: "power2.Out"});

gsap.from(".rightimg", {scrollTrigger: { trigger: ".rightimg", start: "top center"}, x: 100 , opacity: 0, duration: 2, ease: "power2.Out"});
...
gsap.from(".s4Text", {scrollTrigger: { trigger: ".s4Text", start: "center center"}, y: 100 , opacity: 0, duration: 2, ease: "power2.Out"});
